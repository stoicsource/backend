...
class HtmlCleanerTest extends TestCase
{
    public function testStripsTags()
    {
        ...
        $cleanedHtml = $cleaner->clean($taintedHtml, Chapter::ALLOWED_HTML_TAGS_AND_ATTRIBUTES);
    ...
    public function testLeavesAllowedTags()
    {
        ...
        $cleaner = new HtmlCleaner();
        $cleanedHtml = $cleaner->clean($sourceHtml, Chapter::ALLOWED_HTML_TAGS_AND_ATTRIBUTES);
